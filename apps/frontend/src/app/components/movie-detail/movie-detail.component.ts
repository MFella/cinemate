...
export class MovieDetailComponent {
  ...
  @Output()
  readonly markActionButtonClicked$: Subject<MarkButtonData> =
    new Subject<MarkButtonData>();

  getMoviePosterSrc(posterPath: string): string {
    return posterPath
      ? MovieDetailComponent.POSTER_URL_PREFIX + posterPath
      : MovieDetailComponent.POSTER_URL_PLACEHOLDER;
  }
